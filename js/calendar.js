const calendar = document.querySelector("#main-cal-add-student-to-lesson"),
  input = document.querySelector("#input-cal-add-student-to-lesson"),
  calHeader = document.querySelector("#header-cal-add-student-to-lesson"),
  calHeaderTitle = document.querySelector("#header-cal-add-student-to-lesson span"),
  calDays = document.querySelector("#days-cal-add-student-to-lesson"),
  days = [
    "Вс",
    "Пн",
    "Вт",
...
const getDayDetails = (args) => {
  ...
  input.addEventListener('click', () => {
    document.querySelector('#date-picker-cal-add-student-to-lesson').classList.toggle('hidden');
    document.querySelector('#date-picker-input-add-student-to-lesson').classList.toggle('showCal');
    document.querySelector('#input-cal-add-student-to-lesson').classList.toggle('onFocus');
 });